...
const initialMessages = [
  {
    id: 1,
    text: "Good afternoon Professor. For the Database Management assignment, should we implement normalization up to 3NF or BCNF?",
    sender: "student",
    time: "02:10 PM"
  },
  {
    id: 2,
    text: "Good afternoon, Rahul. Implement up to 3NF. BCNF is optional but will earn bonus credit if done correctly.",
    sender: "faculty",
    time: "02:18 PM"
  },
  {
    id: 3,
    text: "Thank you, Professor. Should we also include ER diagrams along with the schema design?",
    sender: "student",
    time: "02:20 PM"
  },
  {
    id: 4,
    text: "Yes, include a properly labeled ER diagram and briefly explain the relationships in your report.",
    sender: "faculty",
    time: "02:27 PM"
  },
  {
    id: 5,
    text: "Understood. I’ll complete the diagrams and submit it before Friday.",
    sender: "student",
    time: "02:30 PM"
  }
];
