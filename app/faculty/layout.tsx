    ...
    <div className="min-h-screen bg-background text-foreground font-sans selection:bg-primary/20 dotgrid relative pb-20">
      ...
      <main className="relative z-10 pt-16 px-6 max-w-7xl mx-auto flex flex-col min-h-[calc(100vh-6rem)]">
        ...
        <header className="flex items-center justify-between mb-8">
          <Link href="/faculty" className="flex items-center gap-3 group">
          ...
          <div className="flex items-center gap-4">
            {pathname !== "/faculty" && (
              <Link href="/faculty" className="px-4 py-2 bg-accent text-accent-foreground border border-border rounded-full text-xs font-bold shadow-sm hover:shadow-md transition-all flex items-center gap-2">
